...
var animals = [dog, cat, bird, mouse];
for (i = 0; i <= animals.length; i++) {
    console.log(animals[i].hunger = 9);
};
/*
...
swan.makeFriend = makdeFriend;
swan.makeFriend(duck);
console.log(swan.friends);



// => { name: 'swan' }

duck.friends.makeNoise();
swan.friends.makeNoise();
// => "chirp quack"
...
//document.querySelector(this.animal) style.background - image = "img src images/ + this.name + .jpg"
